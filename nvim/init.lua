...
vim.keymap.set('n', '<C-n>', '<Cmd>BufferPrevious<CR>', opts)
vim.keymap.set('n', '<C-m>', '<Cmd>BufferNext<CR>', opts)
vim.keymap.set('n', '<A-n>', '<Cmd>BufferMovePrevious<CR>', opts)
vim.keymap.set('n', '<A-m>', '<Cmd>BufferMoveNext<CR>', opts)
